Scriptname DefaultAliasOnTriggerEnter extends DefaultAlias Const Default
...
Event OnTriggerEnter(ObjectReference akActionRef)
	DefaultScriptFunctions.DefaultScriptTrace(self + ": OnTriggerEnter() Called on DefaultAliasOnTriggerEnter script.", ShowTraces)
