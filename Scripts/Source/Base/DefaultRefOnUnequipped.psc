Scriptname DefaultRefOnUnequipped extends DefaultRef Const Default
{Default script used for checking if reference unequipped us, and optionally what Unequipped it.}
...
Event OnUnequipped(Actor akActor)
	DefaultScriptFunctions.DefaultScriptTrace(self + ": OnUnequipped() Called on DefaultRefOnUnequipped script.", ShowTraces)
