...
Scriptname Fragments:TopicInfos:TIF_CIS_RacialComments_Hanco_01168EF4 Extends TopicInfo Hidden Const
...
RacialCommentCount_Hancock_MostRecent_BoS.SetValue(3)
;END CODE
EndFunction
;END FRAGMENT
