...
Scriptname Fragments:TopicInfos:TIF_RadioDiamondCity_00176490 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.currentsong = 27
kmyquest.UpdateRadio()
Debug.Trace(Self+"Radio Update, Song 27")
