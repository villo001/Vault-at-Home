...
Scriptname Fragments:TopicInfos:TIF_RadioDiamondCity_0001934A Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.currentsong = 42
kmyquest.UpdateRadio()
Debug.Trace(Self+"Radio Update, Song 42")
