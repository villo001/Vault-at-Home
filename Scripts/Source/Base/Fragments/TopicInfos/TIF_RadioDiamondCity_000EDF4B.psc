...
Scriptname Fragments:TopicInfos:TIF_RadioDiamondCity_000EDF4B Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.currentsong = 22
kmyquest.UpdateRadio()
Debug.Trace(Self+"Radio Update, Song 22")
