...
Scriptname Fragments:TopicInfos:TIF_RadioDiamondCity_00147715 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.currentsong = 25
kmyquest.UpdateRadio()
Debug.Trace(Self+"Radio Update, Song 25")
