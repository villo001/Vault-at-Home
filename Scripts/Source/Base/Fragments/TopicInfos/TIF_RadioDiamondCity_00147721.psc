...
Scriptname Fragments:TopicInfos:TIF_RadioDiamondCity_00147721 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.currentsong = 34
kmyquest.UpdateRadio()
Debug.Trace(Self+"Radio Update, Song 34")
