...
Scriptname Fragments:TopicInfos:TIF_CIS_RacialComments_Hanco_01168EF2 Extends TopicInfo Hidden Const
...
RacialCommentCount_Hancock_MostRecent_BoS.SetValue(2)
;END CODE
EndFunction
;END FRAGMENT
