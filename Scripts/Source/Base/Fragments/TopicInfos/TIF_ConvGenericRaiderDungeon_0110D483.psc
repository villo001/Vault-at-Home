...
Scriptname Fragments:TopicInfos:TIF_ConvGenericRaiderDungeon_0110D483 Extends TopicInfo Hidden Const

;BEGIN FRAGMENT Fragment_Begin
Function Fragment_Begin(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
if akspeaker.GetCurrentLocation().HasKeyword(RaiderConvo_RegionKeyword)
...
Keyword Property RaiderConvo_RegionKeyword Auto Const
