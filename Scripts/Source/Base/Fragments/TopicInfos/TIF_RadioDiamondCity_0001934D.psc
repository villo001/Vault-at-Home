...
Scriptname Fragments:TopicInfos:TIF_RadioDiamondCity_0001934D Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.currentsong = 45
kmyquest.UpdateRadio()
Debug.Trace(Self+"Radio Update, Song 45")
