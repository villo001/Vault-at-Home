...
Scriptname Fragments:TopicInfos:TIF_RadioDiamondCity_001764A7 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.currentsong = 36
kmyquest.UpdateRadio()
Debug.Trace(Self+"Radio Update, Song 36")
