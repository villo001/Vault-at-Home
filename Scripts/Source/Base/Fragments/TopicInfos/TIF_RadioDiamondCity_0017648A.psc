...
Scriptname Fragments:TopicInfos:TIF_RadioDiamondCity_0017648A Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.currentsong = 24
kmyquest.UpdateRadio()
Debug.Trace(Self+"Radio Update, Song 24")
