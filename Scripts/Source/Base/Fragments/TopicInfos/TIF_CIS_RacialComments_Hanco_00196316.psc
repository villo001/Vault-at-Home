...
Scriptname Fragments:TopicInfos:TIF_CIS_RacialComments_Hanco_00196316 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.iBrotherhoodDialogueCounter = 4
RacialCommentCount_Hancock_MostRecent_BoS.SetValue(4)
;END CODE
EndFunction
;END FRAGMENT
