...
Scriptname Fragments:TopicInfos:TIF_CIS_RacialComments_Hanco_00196313 Extends TopicInfo Hidden Const
...
RacialCommentCount_Hancock_MostRecent_BoS.SetValue(1)
;END CODE
EndFunction
;END FRAGMENT
