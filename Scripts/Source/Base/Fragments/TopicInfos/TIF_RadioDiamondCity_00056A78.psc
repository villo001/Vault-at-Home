...
Scriptname Fragments:TopicInfos:TIF_RadioDiamondCity_00056A78 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.currentsong = 23
kmyquest.UpdateRadio()
Debug.Trace(Self+"Radio Update, Song 23")
