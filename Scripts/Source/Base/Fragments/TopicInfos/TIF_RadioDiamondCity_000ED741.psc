...
Scriptname Fragments:TopicInfos:TIF_RadioDiamondCity_000ED741 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.currentsong = 15
kmyquest.UpdateRadio()
Debug.Trace(Self+"Radio Update, Song 15")
