...
Scriptname Fragments:TopicInfos:TIF_CIS_RacialComments_Hanco_00183D50 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.iDialogueCount = 5
RacialCommentCount_Hancock_MostRecent.SetValue(5)
;END CODE
EndFunction
;END FRAGMENT
