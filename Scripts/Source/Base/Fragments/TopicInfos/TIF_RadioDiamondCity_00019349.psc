...
Scriptname Fragments:TopicInfos:TIF_RadioDiamondCity_00019349 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.currentsong = 41
kmyquest.UpdateRadio()
Debug.Trace(Self+"Radio Update, Song 41")
