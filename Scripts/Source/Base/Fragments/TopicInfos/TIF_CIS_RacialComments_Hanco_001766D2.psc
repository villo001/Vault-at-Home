...
Scriptname Fragments:TopicInfos:TIF_CIS_RacialComments_Hanco_001766D2 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyQuest.iDialogueCount = 8
RacialCommentCount_Hancock_MostRecent.SetValue(8)
;END CODE
EndFunction
;END FRAGMENT
