...
Scriptname Fragments:TopicInfos:TIF_RadioDiamondCity_00176455 Extends TopicInfo Hidden Const
...
;END AUTOCAST
;BEGIN CODE
kmyquest.currentsong =10
kmyquest.UpdateRadio()
Debug.Trace(Self+"Radio Update, Song 10")
