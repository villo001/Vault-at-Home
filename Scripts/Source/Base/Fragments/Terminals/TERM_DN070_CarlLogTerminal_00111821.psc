...
Scriptname Fragments:Terminals:TERM_DN070_CarlLogTerminal_00111821 Extends Terminal Hidden Const

;BEGIN FRAGMENT Fragment_Terminal_02
Function Fragment_Terminal_02(ObjectReference akTerminalRef)
;BEGIN CODE
;Player now knows about the basement.
DN070.SetStage(30)
;END CODE
EndFunction
;END FRAGMENT
...
ObjectReference Property DN070_ProtectronAttackTrigger Auto Const
