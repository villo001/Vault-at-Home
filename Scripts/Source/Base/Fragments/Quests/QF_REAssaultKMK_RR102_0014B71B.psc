...
Scriptname Fragments:Quests:QF_REAssaultKMK_RR102_0014B71B Extends Quest Hidden Const
...
; move and enable Ricky Dalton
actor ricky = Alias_RickyDalton.GetActorRef()
ricky.moveTo(Alias_Defender01Marker.GetRef())
ricky.enable()
...
; disable ricky
Alias_RickyDalton.TryToDisable()
...
ReferenceAlias Property Alias_Object01 Auto Const

ReferenceAlias Property Alias_Defender01Marker Auto Const
