...
Scriptname Fragments:Quests:QF_WorkshopRaiderAttack02NEW_001125E3 Extends Quest Hidden Const
...
if workshopRef.Is3DLoaded() == false && workshopRef.OwnedByPlayer
	WorkshopRaiderAttack02Message.Show()
...
if kmyQuest.CheckResolveAttack()
	if IsObjectiveDisplayed(10)
		WorkshopRaiderAttack02LoseMessage.Show()
	endif
	FailAllObjectives()
else
	if IsObjectiveDisplayed(10) && IsObjectiveCompleted(10) == false
		WorkshopRaiderAttack02WinMessage.Show()
	endif
...
Message Property WorkshopRaiderAttack02Message Auto Const

Message Property WorkshopRaiderAttack02LoseMessage Auto Const Mandatory

Message Property WorkshopRaiderAttack02WinMessage Auto Const Mandatory
