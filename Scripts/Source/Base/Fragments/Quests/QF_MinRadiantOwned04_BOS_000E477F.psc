...
Scriptname Fragments:Quests:QF_MinRadiantOwned04_BOS_000E477F Extends Quest Hidden Const

;BEGIN FRAGMENT Fragment_Stage_0010_Item_00
Function Fragment_Stage_0010_Item_00()
;BEGIN AUTOCAST TYPE MinRadiantOwned04Script
Quest __temp = self as Quest
MinRadiantOwned04Script kmyQuest = __temp as MinRadiantOwned04Script
;END AUTOCAST
;BEGIN CODE
...
setStage(450)
; mod happiness down
; NOT FOR ARTILLERY - only the player cares about that
