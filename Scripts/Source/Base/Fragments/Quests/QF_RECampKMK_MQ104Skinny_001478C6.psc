...
Scriptname Fragments:Quests:QF_RECampKMK_MQ104Skinny_001478C6 Extends Quest Hidden Const
...
actor skinny = Alias_Skinny.GetActorRef()
skinny.MoveTo(Alias_SceneMarker1.GetRef())
skinny.Enable()
skinny.SetValue(Aggression, 0)
...
ReferenceAlias Property Alias_Skinny Auto Const
