...
Scriptname Fragments:Quests:QF_WorkshopRE01_0003DF95 Extends Quest Hidden Const

;BEGIN FRAGMENT Fragment_Stage_0010_Item_00
Function Fragment_Stage_0010_Item_00()
;BEGIN AUTOCAST TYPE WorkshopRE01Script
Quest __temp = self as Quest
WorkshopRE01Script kmyQuest = __temp as WorkshopRE01Script
;END AUTOCAST
;BEGIN CODE
debug.trace(self + " starting")
kmyQuest.Startup()
; steal resources
kmyQuest.DailyUpdateCustom()
; mod happiness down
