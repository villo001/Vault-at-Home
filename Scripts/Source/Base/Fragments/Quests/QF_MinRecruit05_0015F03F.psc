...
Scriptname Fragments:Quests:QF_MinRecruit05_0015F03F Extends Quest Hidden Const
...
; add 2 settlers to the new workshop location
WorkshopScript newWorkshop = Alias_HostileWorkshop.GetRef() as WorkshopScript
kmyQuest.WorkshopParent.CreateActorPUBLIC(newWorkshop)
kmyQuest.WorkshopParent.CreateActorPUBLIC(newWorkshop)
