...
Scriptname Fragments:Quests:QF_RECheckpoint05_Vertibird_000AEA9E Extends Quest Hidden Const
...
RECheckpointMostRecentGlobal.SetValue(5)
...
;BEGIN CODE
;When the vertibird moves in range, begin the assault (handled in scene)
...
((self as Quest) as RECheckpointQuestScript).NonOccupyingAttackerVictory()
