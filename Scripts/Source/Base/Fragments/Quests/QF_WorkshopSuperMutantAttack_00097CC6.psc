...
Scriptname Fragments:Quests:QF_WorkshopSuperMutantAttack_00097CC6 Extends Quest Hidden Const
...
if kmyQuest.CheckResolveAttack()
	if IsObjectiveDisplayed(10)
		WorkshopSuperMutantAttack01LoseMessage.Show()
	endif
	FailAllObjectives()
else
...
Message Property WorkshopSuperMutantAttack01WinMessage Auto Const Mandatory
