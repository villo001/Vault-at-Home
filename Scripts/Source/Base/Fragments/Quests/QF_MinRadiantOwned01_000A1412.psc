...
Scriptname Fragments:Quests:QF_MinRadiantOwned01_000A1412 Extends Quest Hidden Const
...
;BEGIN CODE
setObjectiveCompleted(35)
kmyQuest.FinishQuest(true, GetStageDone(300) == false)
; complete quest
setStage(450)
; mod happiness up
kmyQuest.ModifyWorkshopHappiness(10)
; temp - actually handled in stage 200:
kmyQuest.StopQuestWhenAliasesUnloaded = false
;END CODE
EndFunction
;END FRAGMENT
