...
Scriptname Fragments:Quests:QF_AO_RaiderLightMissing_00083B34 Extends Quest Hidden Const
...
; also mark nearby objects
int i = 0
while i < Alias_OtherMissingLights.GetCount()
	AttractionObjectScript missingLight = Alias_OtherMissingLights.GetAt(i) as AttractionObjectScript
	if missingLight
		missingLight.busy = true
	endif
	i += 1
endWhile
;END CODE
