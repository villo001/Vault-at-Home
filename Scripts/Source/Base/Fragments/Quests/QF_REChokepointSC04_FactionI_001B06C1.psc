...
Scriptname Fragments:Quests:QF_REChokepointSC04_FactionI_001B06C1 Extends Quest Hidden Const
...
;Identify the actors we want to use for this ambush.
...
;When the player enters the chokepoint, enable the synths.
kMyQuest.TeleportIn(kMyQuest.Attackers)
;END CODE
EndFunction
;END FRAGMENT
