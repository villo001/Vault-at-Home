...
Scriptname Fragments:Quests:QF_REAssaultRJ01_001ABE55 Extends Quest Hidden Const
...
if(Utility.RandomInt(0,1) == 0)
	Alias_Behemoth.GetReference().Enable()
	Alias_Behemoth.TrytoEvaluatePackage()
Else
	Alias_MirelurkQueen.GetReference().Enable()
	Alias_MirelurkQueen.TrytoEvaluatePackage()
endif

if (Utility.RandomInt(0, 2) == 0)

	Alias_GunnerDefenderPA.GetReference().Enable()

EndIf

if (Utility.RandomInt(0, 1) == 0)

	Alias_GunnerDefenderRobot.GetReference().Enable()
...
ReferenceAlias Property Alias_GunnerDefenderPA Auto Const

ReferenceAlias Property Alias_GunnerDefenderRobot Auto Const

ReferenceAlias Property Alias_Behemoth01 Auto Const
