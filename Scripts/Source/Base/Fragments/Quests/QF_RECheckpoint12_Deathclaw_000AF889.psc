...
Scriptname Fragments:Quests:QF_RECheckpoint12_Deathclaw_000AF889 Extends Quest Hidden Const
...
RECheckpointMostRecentGlobal.SetValue(12)
...
;Wait and see if defenders are in combat with attackers. If so, throw objective
Utility.Wait(3.0)
