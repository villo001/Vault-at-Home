...
Scriptname Fragments:Quests:QF_WorkshopSuperMutantAttack_0024918C Extends Quest Hidden Const
...
; 1.3: 87236 - update group size for added hounds
...
if kmyQuest.CheckResolveAttack()
	if IsObjectiveDisplayed(10)
		WorkshopSuperMutantAttack02LoseMessage.Show()
	endif
	FailAllObjectives()
else
	if IsObjectiveDisplayed(10) && IsObjectiveCompleted(10) == false
		WorkshopSuperMutantAttack02WinMessage.Show()
	endif
...
Message Property WorkshopSuperMutantAttack02LoseMessage Auto Const Mandatory

Message Property WorkshopSuperMutantAttack02WinMessage Auto Const Mandatory
