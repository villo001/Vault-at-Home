...
Scriptname Fragments:Quests:QF_MinAO_Min02ShootAtEggs03_0012A204 Extends Quest Hidden Const
...
ObjectReference MyActorRef = Alias_Attacker01.GetReference()
Actor MyActor = Alias_Attacker01.GetActorRef()
...
;BEGIN CODE
Alias_Attacker01.GetReference().SetLinkedRef(NONE, AO_Min02EggShootingPosition)
Alias_Attacker01.GetActorRef().EvaluatePackage()
Stop()
;END CODE
EndFunction
;END FRAGMENT
