...
Scriptname Fragments:Quests:QF_RECheckpointBoSWon03_Init_000AC4D2 Extends Quest Hidden Const
...
;/
if RECheckpointKeyword.SendStoryEventAndWait(akLoc = Alias_CheckpointLocation.GetLocation(), akRef1 = Alias_Trigger.GetRef())

else
  ;Rearm the trigger if a quest doesn't fire
