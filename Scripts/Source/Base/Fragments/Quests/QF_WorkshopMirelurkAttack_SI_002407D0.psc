...
Scriptname Fragments:Quests:QF_WorkshopMirelurkAttack_SI_002407D0 Extends Quest Hidden Const
...
if kmyQuest.CheckResolveAttack()
	if IsObjectiveDisplayed(10)
		WorkshopMirelurkAttack_SI_LoseMessage.Show()
	endif
	FailAllObjectives()
else
	if IsObjectiveDisplayed(10) && IsObjectiveCompleted(10) == false
		WorkshopMirelurkAttack_SI_WinMessage.Show()
	endif
...
Message Property WorkshopMirelurkAttack_SI_LoseMessage Auto Const Mandatory

Message Property WorkshopMirelurkAttack_SI_WinMessage Auto Const Mandatory
