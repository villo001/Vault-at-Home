...
Scriptname Fragments:Quests:QF_REAssaultSC15_FactionBoSv_001AEF29 Extends Quest Hidden Const
...
;Since this is a Relay encounter, we also need to enable the synths.
