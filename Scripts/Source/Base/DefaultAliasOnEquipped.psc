Scriptname DefaultAliasOnEquipped extends DefaultAlias Const Default
...
Event OnEquipped(Actor akActor)
		DefaultScriptFunctions.DefaultScriptTrace(self + ": OnEquipped() Called on DefaultAliasONONEquipped script.", ShowTraces)
