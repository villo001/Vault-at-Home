...
CustomEvent CompanionAffinityEvent 
...
CompanionAffinityEventQuestScript Function GetScript() global ;used for making functions global
	return (Game.GetFormFromFile(0x001c5099, "Fallout4.esm") as Quest) as CompanionAffinityEventQuestScript ;this script attached to CompanionAffinity quest
EndFunction

event onInit()
	RegisterForCustomEvent(self, "CompanionAffinityEvent")
endEvent

function SendAffinityBumpEvent(ScriptObject sender, int eventID)
	
	Var[] kargs = new Var[3]

	if sender is TopicInfo
		kargs[0] = (sender as TopicInfo).GetOwningQuest()
	...
	debug.trace(" 	sending CompanionAffinityEvent")
	SendCustomEvent("CompanionAffinityEvent", kargs)		
endFunction
...
function Cait_Dislikes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_CaitDislikes, CheckCompanionProximity = true)
endFunction

function Cait_Hates(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_CaitHates, CheckCompanionProximity = true)
endFunction

function Cait_Likes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_CaitLikes, CheckCompanionProximity = true)
endFunction

function Cait_Loves(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_CaitLoves, CheckCompanionProximity = true)
endFunction
...
function Codsworth_Dislikes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_CodsworthDislikes, CheckCompanionProximity = true)
endFunction

function Codsworth_Hates(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_CodsworthHates, CheckCompanionProximity = true)
endFunction

function Codsworth_Likes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_CodsworthLikes, CheckCompanionProximity = true)
endFunction

function Codsworth_Loves(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_CodsworthLoves, CheckCompanionProximity = true)
endFunction
...
function Curie_Dislikes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_CurieDislikes, CheckCompanionProximity = true)
endFunction

function Curie_Hates(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_CurieHates, CheckCompanionProximity = true)
endFunction

function Curie_Likes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_CurieLikes, CheckCompanionProximity = true)
endFunction

function Curie_Loves(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_CurieLoves, CheckCompanionProximity = true)
endFunction
...
function Danse_Dislikes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_DanseDislikes, CheckCompanionProximity = true)
endFunction

function Danse_Hates(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_DanseHates, CheckCompanionProximity = true)
endFunction

function Danse_Likes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_DanseLikes, CheckCompanionProximity = true)
endFunction

function Danse_Loves(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_DanseLoves, CheckCompanionProximity = true)
endFunction
...
function Deacon_Dislikes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_DeaconDislikes, CheckCompanionProximity = true)
endFunction

function Deacon_Hates(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_DeaconHates, CheckCompanionProximity = true)
endFunction

function Deacon_Likes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_DeaconLikes, CheckCompanionProximity = true)
endFunction

function Deacon_Loves(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_DeaconLoves, CheckCompanionProximity = true)
endFunction
...
function Hancock_Dislikes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_HancockDislikes, CheckCompanionProximity = true)
endFunction

function Hancock_Hates(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_HancockHates, CheckCompanionProximity = true)
endFunction

function Hancock_Likes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_HancockLikes, CheckCompanionProximity = true)
endFunction

function Hancock_Loves(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_HancockLoves, CheckCompanionProximity = true)
endFunction
...
function MacCready_Dislikes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_MacCreadyDislikes, CheckCompanionProximity = true)
endFunction

function MacCready_Hates(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_MacCreadyHates, CheckCompanionProximity = true)
endFunction

function MacCready_Likes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_MacCreadyLikes, CheckCompanionProximity = true)
endFunction

function MacCready_Loves(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_MacCreadyLoves, CheckCompanionProximity = true)
endFunction
...
function Piper_Dislikes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_PiperDislikes, CheckCompanionProximity = true)
endFunction

function Piper_Hates(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_PiperHates, CheckCompanionProximity = true)
endFunction

function Piper_Likes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_PiperLikes, CheckCompanionProximity = true)
endFunction

function Piper_Loves(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_PiperLoves, CheckCompanionProximity = true)
endFunction
...
function Preston_Dislikes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_PrestonDislikes, CheckCompanionProximity = true)
endFunction

function Preston_Hates(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_PrestonHates, CheckCompanionProximity = true)
endFunction

function Preston_Likes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_PrestonLikes, CheckCompanionProximity = true)
endFunction

function Preston_Loves(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_PrestonLoves, CheckCompanionProximity = true)
endFunction
...
function Strong_Dislikes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_StrongDislikes, CheckCompanionProximity = true)
endFunction

function Strong_Hates(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_StrongHates, CheckCompanionProximity = true)
endFunction

function Strong_Likes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_StrongLikes, CheckCompanionProximity = true)
endFunction

function Strong_Loves(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_StrongLoves, CheckCompanionProximity = true)
endFunction
...
function Valentine_Dislikes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_ValentineDislikes, CheckCompanionProximity = true)
endFunction

function Valentine_Hates(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_ValentineHates, CheckCompanionProximity = true)
endFunction

function Valentine_Likes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_ValentineLikes, CheckCompanionProximity = true)
endFunction

function Valentine_Loves(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_ValentineLoves, CheckCompanionProximity = true)
endFunction
...
function X688_Dislikes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_X688Dislikes, CheckCompanionProximity = true)
endFunction

function X688_Hates(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_X688Hates, CheckCompanionProximity = true)
endFunction

function X688_Likes(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_X688Likes, CheckCompanionProximity = true)
endFunction

function X688_Loves(bool CheckCompanionProximity = true)
	SendAffinityEvent(CA_CustomEvent_X688Loves, CheckCompanionProximity = true)
endFunction
...
function SendAffinityEvent(keyword affinityKeyword, bool CheckCompanionProximity = true)
	...
	FollowersScript.SendAffinityEvent(self, affinityKeyword, ShouldSuppressComment = false, IsDialogueBump = true, CheckCompanionProximity = true)
endFunction
...
function HandleDialogueBump_BoS100(Quest eventQuest, int eventID)
	...
	if eventQuest == BoS100
		...
		elseif eventID == 3
		 ...
		 debug.trace(self + " WARNING - HandleDialogueBump_BoS100 got event from wrong quest " + eventQuest)
	endif
endFunction
...
function HandleDialogueBump_BoS101(Quest eventQuest, int eventID)
	...
	if eventQuest == BoS101
		...
		elseif eventID == 3
		 ...
		 debug.trace(self + " WARNING - HandleDialogueBump_BoS101 got event from wrong quest " + eventQuest)
	endif
endFunction
...
function HandleDialogueBump_DialogueGoodneighbor(Quest eventQuest, int eventID)
	...
	if eventQuest == DialogueGoodneighbor
		...
		elseif eventID == 33
			...
			if CaitRef.IsRomantic()
				Cait_Hates()
			endif
			if CurieRef.IsRomantic()
				Curie_Hates()
			endif
			if BoSPaladinDanseRef.IsRomantic()
				Danse_Hates()
			endif
			if HancockRef.IsRomantic()
				Hancock_Hates()
			endif
			if CompMacCreadyRef.IsRomantic()
				MacCready_Hates()
			endif
			if PiperRef.IsRomantic()
				Piper_Hates()
			endif
			if PrestonRef.IsRomantic()
				Preston_Hates()
			endif
		elseif eventID == 34
			 ; 0011283A on quest DialogueGoodneighbor (00033582)
...
function HandleDialogueBump_MS17(Quest eventQuest, int eventID)
	...
	if eventQuest == MS17
		...
		elseif eventID == 11
			 ...
			 ; DESCRIPTION: Player is at compound gate talking to Manny, who won't let him in. Player tries
			 ; to negotiate his way in peacefully.
			Cait_Neutral()
			Codsworth_Likes()
			Curie_Likes()
			Danse_Likes()
		...
		elseif eventID == 12
			 ...
			 ; DESCRIPTION: Jacob Orden wants Player to ignore the investigation. Player rejects the bribe
			 ; that's offered.
			Cait_Dislikes()
			Codsworth_Likes()
			Curie_Neutral()
		...
		elseif eventID == 18
			 ...
			 ; DESCRIPTION: Doctor Chambers is going to dispose of Amelia Stockton. She offers a bribe
			 ; if Player lets her do it. Player takes it.
			Cait_Likes()
			Codsworth_Hates()
			Curie_Neutral()
			Danse_Neutral()
...
function HandleDialogueBump_MS19(Quest eventQuest, int eventID)
	...
	if eventQuest == MS19
		if eventID == 1 || eventID == 4
			 ...
			 ; DESCRIPTION: Player has a cure for a unique molerat disease in hand. There's only one dose.
			 ; A kid in a Vault needs the cure, or he'll die. Player refuses to give it to kid
			Cait_Likes()
			Codsworth_Hates()
			Curie_Dislikes()
			Danse_Dislikes()
		...
		elseif eventID == 2
			 ...
			 ; DESCRIPTION: Player has a cure for a unique molerat disease in hand. There's only one dose.
			 ; A kid in a Vault needs the cure, or he'll die. Player wants to split the dose between himself
			 ; and the kid
			Cait_Dislikes()
			Codsworth_Dislikes()
			Curie_Dislikes()
		...
		elseif eventID == 3
			 ...
			 ; DESCRIPTION: Player has a cure for a unique molerat disease in hand. There's only one dose.
			 ; A kid in a Vault needs the cure, or he'll die. Player gives it to kid and suffers a permanent
			 ; health debuff
			Cait_Dislikes()
			Codsworth_Loves()
			Curie_Likes()
...
function HandleDialogueBump_RECampLC01(Quest eventQuest, int eventID)
	...
	if eventQuest == RECampLC01
		...
		elseif eventID == 4
			 ...
			 ; DESCRIPTION: Player is attacking the captors of a man who has begged the player to help him 
			 ; (Player doesn't know he's a Synth)
			Cait_Neutral()
			Codsworth_Likes()
			Curie_Likes()
			Danse_Likes()
		...
		elseif eventID == 6
			 ...
			 ; DESCRIPTION: Player threatens violence against a pair of hostage takers threatening to kill
			 ; a Synth
			Cait_Likes()
			Codsworth_Hates()
			Curie_Hates()
		...
		elseif eventID == 12
			 ...
			 ; DESCRIPTION: Player has stumbled across a two people threatening to execute someone
			 ; and has decided to not get involved (player doesn't know the man is a Synth)
			Cait_Likes()
			Codsworth_Dislikes()
			Curie_Dislikes()
			Danse_Dislikes()
...
function HandleDialogueBump_RESceneLC01(Quest eventQuest, int eventID)
	...
	if eventQuest == RESceneLC01
		if eventID == 1
			 ...
			 ; DESCRIPTION: Player has come across two men with the same face, both claiming the other
			 ; is a Synth. The player encouraged one man to execute the other, despite not knowing who
			 ; is actually the Synth
			Cait_Likes()
			Codsworth_Dislikes()
			Curie_Dislikes()
			Danse_Dislikes()
		...
		elseif eventID == 2
			 ...
			 ; DESCRIPTION: Player has come across two men with the same face, both claiming the other is a Synth. 
			 ; The player has uncovered which is the Synth and encouraged the Synth's execution
			Cait_Likes()
			Codsworth_Dislikes()
			Curie_Dislikes()
			Danse_Likes()
		...
		elseif eventID == 3
			 ...
			 ; DESCRIPTION: Player has come across two men with the same face, both claiming the other is a Synth. 
			 ; Player has uncovered who is the Institute Synth and has decided to attack the other man
			Cait_Neutral()
			Codsworth_Dislikes()
			Curie_Dislikes()
			Danse_Hates()
		...
		elseif eventID == 4
			 ...
			 ; DESCRIPTION: Player has come across two men with the same face, both claiming the other is a Synth. 
			 ; One has a gun to the other's head. Player has decided to not intervene in the execution
			 ; (Player doesn't know who the Synth is)
			Cait_Neutral()
			Codsworth_Dislikes()
			Curie_Dislikes()
			Danse_Dislikes()
		...
		elseif eventID == 5
			 ...
			 ; DESCRIPTION: Player has come across two men with the same face, both claiming the other is a Synth. 
			 ; Player attacks the man holding the gun, not knowing who the Synth actually is
			Cait_Likes()
			Codsworth_Dislikes()
			Curie_Dislikes()
			Danse_Dislikes()
		...
		elseif eventID == 6
			 ...
			 ; DESCRIPTION: Player has come across two men with the same face, both claiming the other is a Synth. 
			 ; Player encourages one man to execute the other, not knowing who is the Synth
			Cait_Likes()
			Codsworth_Dislikes()
			Curie_Dislikes()
			Danse_Dislikes()
		...
		elseif eventID == 7
			 ...
			 ; DESCRIPTION: Player attempts to find a peaceful solution with a man pointing a gun at suspected Synth
		...
		elseif eventID == 9
			 ...
			 ; DESCRIPTION: Player has come across two men with the same face, both claiming the other is a Synth. 
			 ; Player has uncovered which is the Synth and encourages the man to execute him
			Cait_Likes()
			Codsworth_Dislikes()
			Curie_Dislikes()
			Danse_Loves()
