Scriptname DefaultRefOnCombatStateChanged extends DefaultActor Const Default
...
Event OnCombatStateChanged(Actor akTarget, int aeCombatState)
	if ((aeCombatState > 0) && (CombatStateToCheckFor == 4)) || (aeCombatState == CombatStateToCheckFor)
		DefaultScriptFunctions.DefaultScriptTrace(self + ": OnCombatStateChanged() Called on DefaultRefOnCombatStateChanged script.", ShowTraces)
