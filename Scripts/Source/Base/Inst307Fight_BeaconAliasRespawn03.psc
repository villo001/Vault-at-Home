Scriptname Inst307Fight_BeaconAliasRespawn03 extends ReferenceAlias Hidden
...
function RespawnIfDead()
	...
	if GetActorRef().IsDead()
		Inst307Fight_BeaconQuestRespawn03 myQuest = GetOwningQuest() as Inst307Fight_BeaconQuestRespawn03
